...
class Order {
     ...
     * An order for a notas from the nota store
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('notaId')) {
                obj['notaId'] = ApiClient.convertToType(data['notaId'], 'Number');
            }
...
/**
 * @member {Number} notaId
 */
Order.prototype['notaId'] = undefined;
