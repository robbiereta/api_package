...
let apiInstance = new OpenApiNotastore.UserApi();
let user = new OpenApiNotastore.User(); // User | Created user object
...
let apiInstance = new OpenApiNotastore.UserApi();
let user = [new OpenApiNotastore.User()]; // [User] | List of user object
...
let user = new OpenApiNotastore.User(); // User | Updated user object
